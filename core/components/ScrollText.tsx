...
export default function ScrollText({ text }: { text: string }) {
    function ParallaxText({ children, baseVelocity = 100 }: ParallaxProps) {
        ...
        return (
            <div className="parallax">
                <motion.div
                    className="scroller text-center font-display text-4xl font-bold tracking-[-0.02em] drop-shadow-sm md:text-7xl md:leading-[5rem] w-full"
                    style={{ x }}
                >
    ...
    const containerWidth = "1214px";
    const textWidth = "693.102px";
