...
import TextTransition from '@/core/components/TextTransition'
...
const BentoCard = ({ children, className }: { children: ReactNode; className?: string }) => (
    <div
        className={cn(
            ...
            // light styles
            "bg-white/0 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
            // dark styles
...
export default function LandingPage() {
    const EverTech = () => (
        <span className='text-red-200 px-6 py-2 bg-slate-500 rounded-full inline-block'>
            EverTech
        </span>
    )

    return (
        <div className='absolute top-0 left-0 h-full w-full flex flex-col pt-24 px-16 pb-16'>
            <div className='flex flex-col w-full h-full gap-8'>
                ...
                <div className='row-2 flex flex-row gap-8 h-full'>
                    <BentoCard className='text-7xl p-8 w-full'>
